%% This file is to test on the treadmill/TDT computer - with the nidaq attached. 
...
% format.
delete(imaqfind)
videoObject_1 = videoinput('tisimaq_r2013_64', '1', 'Y800 (1280x1024)');
videoObject_1.ReturnedColorspace = "grayscale";
% videoObject_1.ROIPosition =  [239 535 785 232];
videoObject_1.ROIPosition =  [428 630 785 232];
...
videoObject_2 = videoinput('tisimaq_r2013_64', '2', 'Y800 (1280x1024)');
videoObject_2.ReturnedColorspace = "grayscale";
videoObject_2.ROIPosition =  [445 760 785 232];
